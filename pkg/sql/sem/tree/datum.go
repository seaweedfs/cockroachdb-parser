...
import (
	...
	"github.com/seaweedfs/cockroachdb-parser/pkg/sql/pgrepl/lsn"
	...
	"github.com/seaweedfs/cockroachdb-parser/pkg/util/tsearch"
	"github.com/seaweedfs/cockroachdb-parser/pkg/util/uint128"
	"github.com/seaweedfs/cockroachdb-parser/pkg/util/uuid"
	"github.com/seaweedfs/cockroachdb-parser/pkg/util/vector"
...
func (d *DJSON) Format(ctx *FmtCtx) {
	...
	if ctx.HasFlags(fmtRawStrings) || ctx.HasFlags(fmtPgwireFormat) {
		...
		// see https://github.com/seaweedfs/cockroachdb-parser/issues/60673
